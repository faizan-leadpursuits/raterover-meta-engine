"""
Idealo hotel scraper — curl_cffi HTML scraper for www.idealo.com.
"""
...
class IdealoScraper:
    ...
    def search(self, city: str, check_in: str, check_out: str,
        ...
        logger.info("[idealo] Searching '%s'...", city)
        url = "https://flights-and-hotels.idealo.com/hotels/{city}?checkin={check_in}&checkout={check_out}&adults={adults}&rooms={rooms}".format(
        ...
        try:
            ...
            if resp.status_code != 200:
                logger.warning("[idealo] Status %d", resp.status_code)
                return []
            return self._parse(resp.text or "", city, currency)
        except Exception as e:
            logger.error("[idealo] Error: %s", e)
            return []
