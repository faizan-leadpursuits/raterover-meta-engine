...
class IdealoAdapter(HotelBaseAdapter):
    NAME = "idealo"
    DOMAIN = "hotels"
    NEEDS_PROXY = True
    ...
    def search(self, city: str, check_in: str, check_out: str,
        ...
        try:
            raw = IdealoScraper(proxy=proxy).search(city, check_in, check_out, adults, rooms, currency)
        ...
        for h in raw:
            ...
            rows.append(make_hotel_row(
                ...
                booking_provider="Idealo", cancellation="", amenities="",
