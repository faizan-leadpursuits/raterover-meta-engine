"""
SkyscannerHotels hotel scraper — curl_cffi HTML scraper for www.skyscanner.com.
"""
...
class SkyscannerHotelsScraper:
    ...
    def search(self, city: str, check_in: str, check_out: str,
        ...
        logger.info("[skyscanner_hotels] Searching '%s'...", city)
        url = "https://www.skyscanner.com/hotels/{city}/{check_in}/{check_out}/guests/{adults}".format(
        ...
        try:
            ...
            if resp.status_code != 200:
                logger.warning("[skyscanner_hotels] Status %d", resp.status_code)
                return []
            return self._parse(resp.text or "", city, currency)
        except Exception as e:
            logger.error("[skyscanner_hotels] Error: %s", e)
            return []
