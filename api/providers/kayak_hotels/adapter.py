...
from .scraper import KayakHotelsScraper

logger = logging.getLogger(__name__)

class KayakHotelsAdapter(HotelBaseAdapter):
    NAME = "kayak_hotels"
    DOMAIN = "hotels"
    NEEDS_PROXY = True
    ...
    def search(self, city: str, check_in: str, check_out: str,
        ...
        try:
            raw = KayakHotelsScraper(proxy=proxy).search(city, check_in, check_out, adults, rooms, currency)
        ...
        for h in raw:
            ...
            rows.append(make_hotel_row(
                ...
                booking_provider="Kayak", cancellation="", amenities="",
