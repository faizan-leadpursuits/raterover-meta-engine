"""
Orbitz adapter — uses the unified ExpediaGroupScraper GraphQL engine.
"""
...
class OrbitzAdapter(HotelBaseAdapter):
    NAME = "orbitz"
    DOMAIN = "hotels"
    NEEDS_PROXY = True
    ...
    def search(self, city, check_in, check_out, adults=2, children=0, rooms=1, currency="USD", **kw):
        ...
        # 1. Resolve Region (Orbitz uses the same regionIds as Expedia)
        ...
        scraper = ExpediaGroupScraper(brand="orbitz", proxy=proxy_url)
