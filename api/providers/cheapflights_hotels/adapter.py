"""{display} adapter — normalizes scraper output to universal hotel schema."""
import logging
from datetime import datetime
import pandas as pd
from core.hotel_base_adapter import HotelBaseAdapter
from core.hotel_schemas import make_hotel_row
from .scraper import CheapflightsHotelsScraper

logger = logging.getLogger(__name__)

class CheapflightsHotelsAdapter(HotelBaseAdapter):
    NAME = "cheapflights_hotels"
    DOMAIN = "hotels"
    NEEDS_PROXY = True
    ...
    def search(self, city: str, check_in: str, check_out: str,
        ...
        try:
            raw = CheapflightsHotelsScraper(proxy=proxy).search(city, check_in, check_out, adults, rooms, currency)
        ...
        for h in raw:
            ...
            rows.append(make_hotel_row(
                ...
                booking_provider="Cheapflights", cancellation="", amenities="",
