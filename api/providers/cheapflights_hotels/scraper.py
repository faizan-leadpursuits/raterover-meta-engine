"""
CheapflightsHotels hotel scraper — curl_cffi HTML scraper for www.cheapflights.com.
"""
...
class CheapflightsHotelsScraper:
    ...
    def search(self, city: str, check_in: str, check_out: str,
        ...
        logger.info("[cheapflights_hotels] Searching '%s'...", city)
        url = "https://www.cheapflights.com/hotels/{city}/{check_in}/{check_out}/{rooms}rooms/{adults}adults".format(
        ...
        try:
            ...
            if resp.status_code != 200:
                logger.warning("[cheapflights_hotels] Status %d", resp.status_code)
                return []
            return self._parse(resp.text or "", city, currency)
        except Exception as e:
            logger.error("[cheapflights_hotels] Error: %s", e)
            return []
