"""
HotelsCombined hotel scraper — curl_cffi HTML scraper for www.hotelscombined.com.
"""
...
class HotelsCombinedScraper:
    ...
    def search(self, city: str, check_in: str, check_out: str,
        ...
        logger.info("[hotelscombined] Searching '%s'...", city)
        url = "https://www.hotelscombined.com/hotels/{city}/{check_in}/{check_out}/{rooms}rooms/{adults}adults".format(
        ...
        try:
            ...
            if resp.status_code != 200:
                logger.warning("[hotelscombined] Status %d", resp.status_code)
                return []
            return self._parse(resp.text or "", city, currency)
        except Exception as e:
            logger.error("[hotelscombined] Error: %s", e)
            return []
