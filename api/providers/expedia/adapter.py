"""
Expedia adapter — uses the unified ExpediaGroupScraper GraphQL engine.
"""
...
class ExpediaAdapter(HotelBaseAdapter):
    NAME = "expedia"
    DOMAIN = "hotels"
    NEEDS_PROXY = True
    ...
    def search(self, city, check_in, check_out, adults=2, children=0, rooms=1, currency="USD", **kw):
        ...
        # 1. Resolve Region (Expedia uses the same regionIds as Hotels.com)
